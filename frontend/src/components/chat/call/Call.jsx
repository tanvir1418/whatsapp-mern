...
export default function Call({
    ...
    return (
        ...
        `}
            ...
            >
                ...
                <div>
                    <div>
                        ...
                        <Header />
                        {/* Call area */}
                        <CallArea name={name} totalSecInCall={totalSecInCall} setTotalSecInCall={setTotalSecInCall} callAccepted={callAccepted} />
                        {/* Call actions */}
            ...
            {/* Ringing */}
            {receivingCall && !callAccepted ? <Ringing call={call} setCall={setCall} answerCall={answerCall} endCall={endCall} /> : null}
            {/* calling ringtone */}
