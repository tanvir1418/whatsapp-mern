...
const Picture = ({ readablePicture, setReadablePicture, setPicture }) => {
    ...
    const handlePicture = (e) => {
        ...
        if (picture.type !== "image/jpeg" && picture.type !== "image/png" && picture.type !== "image/webp") {
        ...
        <div className="mt-8 content-center dark:text-dark_text_1 space-y-1">
            ...
            {readablePicture ? (
                <div>
                    ...
                    <img src={readablePicture} alt="Profile Picture" className="w-20 h-20 object-cover rounded-full" />
                    {/* change picture */}
                    <div
