        ...
        >
            <div className="relative w-full flex items-center justify-between py-[10px]">
                ...
                <div className="flex flex-col gap-7-4 items-end text-xs">
                    <span className="dark:text-dark_text_2">{convo.latestMessage?.createdAt ? dateHandler(convo.latestMessage?.createdAt) : ""}</span>
                </div>
            </div>
            {/* Border */}
...
const ConversationWithContext = (props) => <SocketContext.Consumer>{(socket) => <Conversation {...props} socket={socket} />}</SocketContext.Consumer>;
